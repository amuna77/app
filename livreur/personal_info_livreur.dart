...
class PersonalInformationPageLivreur extends StatefulWidget {
  @override
  _PersonalInformationPageLivreurState createState() =>
      _PersonalInformationPageLivreurState();
}

class _PersonalInformationPageLivreurState
    extends State<PersonalInformationPageLivreur> {
  ...
  Future<void> fetchUserInfo() async {
    try {
      String livreurId = FirebaseAuth.instance.currentUser!.uid;
      DocumentSnapshot documentSnapshot =
          await firestore.collection('livreurs').doc(livreurId).get();
  ...
  Future<void> updateUserInformation({
    ...
    try {
      ...
      if (image != null) {
        String imageFileName = livreurId + '_' + DateTime.now().toString();
        Reference storageReference = FirebaseStorage.instance
            .ref()
            .child('profile_images_livreur/$imageFileName');
      ...
      Map<String, dynamic> updateData = {
        ...
        'image': _imageUrl,
        'gender': gender, // Ajouter le genre à mettre à jour
      };

      // Update user information in Firestore
      DocumentReference livreurRef =
          firestore.collection('livreurs').doc(livreurId);
      if (userData.exists) {
